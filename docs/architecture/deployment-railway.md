...
| `RESEND_FROM_EMAIL` | optional, defaults to `Seguimiento de Cirugías <onboarding@resend.dev>` | Same ADRs. The default is Resend's shared sandbox sender — fine for the owner's own test emails, not for real physicians once confirmation is re-enabled (needs a verified domain first).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
