...
**Status**: `IN_PROGRESS` — **WP1, WP2 and WP3 are implemented and merged
to `main`** (`feat/milestone-11-alignment` for WP1+WP2,
`feat/milestone-11-wp3` for WP3). Full quality gate green (domain 117 /
